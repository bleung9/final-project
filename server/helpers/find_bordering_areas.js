...
// for each list of neighborhoods that a coordinate delineates, because of the way the geoJSON data
// is set up, we know that all of those neighborhoods share a border with every  other item in that list
// it's now trivial to obtain a list of neighborhoods that share a border with each neighborhood.
let result = {};
...
// remove self matches from the list
for (item in result) {
